...
export const metadata = {
  title: 'Schengen Visa from UAE 2026 — Complete Guide & Expert Assistance | Visa Express Hub',
  description:
    'Expert Schengen visa assistance in Dubai (UAE) and Dhaka (Bangladesh). One visa covers all 29 European countries — €90 fee, 15-day processing. High success rate for tourist, business & student visas. Call +971 50 707 8334.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Planning a trip to Europe? One Schengen visa covers 29 countries. Get professional assistance from our specialists in Dubai and Dhaka — €90 fee, 15-day processing, high success rate. Call +971 50 707 8334.',
  ...
  twitter: {
    ...
    title: 'Schengen Visa from UAE 2026 | Expert Consultants Dubai & Dhaka | Visa Express Hub',
    description:
      'Expert assistance for Schengen visas — all 29 European countries. Offices in Dubai (UAE) and Dhaka (Bangladesh). High success rate. Call +971 50 707 8334 today.',
  ...
  '@graph': [
    {
      ...
      description:
        'Comprehensive Schengen visa processing and documentation support for all 29 European member states. We assist UAE and Bangladesh residents with appointments, documentation, application submission, and cover letter preparation.',
      areaServed: [
      ...
      offers: {
        '@type': 'Offer',
        description:
          'Professional consultancy for Schengen tourist, business, and student visas. Official fee: €90 for adults. Processing time: 15 days.',
        price: '90',
        priceCurrency: 'EUR',
      },
    },
    {
      ...
      description:
        'Visa Express Hub is a leading visa consultancy specialising in Schengen, UK, USA, and Canada visas with dedicated offices in Dubai and Dhaka.',
    ...
    },
    {
      ...
      url: 'https://www.visaexpresshub.com/schengen-visa',
      name: 'Schengen Visa from UAE 2026 — Complete Guide & Expert Assistance | Visa Express Hub',
      description:
        'Complete guide and professional assistance for obtaining a Schengen Visa from Dubai, UAE or Dhaka, Bangladesh. Covers fees, documents, processing times, and all 29 member countries.',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Visa Services', item: 'https://www.visaexpresshub.com/visa-services' },
          { '@type': 'ListItem', position: 3, name: 'Schengen Visa', item: 'https://www.visaexpresshub.com/schengen-visa' },
        ],
      },
    },
    {
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'A Schengen visa allows stays of up to 90 days in any 180-day rolling period across all 29 Schengen countries combined. Days are counted across the entire area — not per country.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Standard Schengen visa processing takes 15 calendar days. In complex cases it can extend to 45 days. We recommend applying at least 4–6 weeks before your travel date, and even earlier during peak summer months.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'The Schengen visa covers 29 European countries including France, Germany, Italy, Spain, Greece, Switzerland, Netherlands, Portugal, Austria, Belgium, and more.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Common requirements include a valid passport (valid 3+ months beyond departure), UAE residency visa, completed application form, passport photograph, travel medical insurance (min. €30,000), confirmed flight itinerary, hotel bookings, bank statements (3–6 months), employment letter, and visa fee payment of €90.',
          },
        },
        {
          '@type': 'Question',
          name: 'What if my Schengen visa application is refused?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'You will receive a written refusal letter stating the reason. You have the legal right to appeal. Our team can help prepare a strong appeal or reapplication with stronger supporting evidence.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes, our Dhaka office provides full support for Schengen visa applications for Bangladeshi citizens, including document preparation, cover letters, and application guidance.',
          },
        },
      ],
    },
      ...
      <div className="max-w-6xl mx-auto px-6 mt-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <main className="lg:col-span-2 space-y-8">
            ...
            {/* ── 29 SCHENGEN COUNTRIES — CLIENT COMPONENT ── */}
            <section className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
          ...
          <aside className="space-y-5">
            ...
            {/* Quick country links in sidebar — CLIENT COMPONENT */}
