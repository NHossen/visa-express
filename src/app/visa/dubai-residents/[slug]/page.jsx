...
async function getVisaData(slug) {
  const client = await clientPromise;
  const db = client.db('Eammu-Holidays');
  const doc = await db.collection('dubairesidentvisadata')
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    twitter: {
      ...
      title:       `${countryName} Visa from Dubai ${currentYear} — UAE Resident Guide`,
        ...
        {relatedNames.map((name, i) => {
          ...
          return (
            <Link
              ...
              title={`${name} tourist visa for Dubai & UAE residents`}
...
function Breadcrumb({ countryName, dark = false }) {
  ...
  return (
    <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs font-semibold mb-8 flex-wrap">
      ...
      <Link href="/visa/dubai-residents"      style={{ color: muted }} className="hover:text-white transition">Visa Guide — Dubai Residents</Link>
      <ChevronRight size={12} style={{ color: muted }} />
...
function FallbackVisaPage({ country, whatsappUrl, allCountries }) {
  ...
  const commonDocs = [
    "Original passport valid for minimum 6 months beyond travel dates, with at least 2 blank visa pages",
    "All previous passports (if any) — submit complete history for visa record",
    "Valid UAE Residence Visa copy (all pages)",
    ...
    "Confirmed round-trip flight reservation (refundable or dummy ticket from Dubai)",
    "Hotel booking / accommodation proof for entire duration of stay",
    "UAE bank statement — last 3 to 6 months (minimum AED 10,000–20,000 balance recommended)",
    "Salary certificate / employment letter from UAE employer (on company letterhead)",
    "Cover letter clearly stating purpose of travel, itinerary, and confirmed return to UAE",
    "Travel insurance covering medical emergencies for the entire trip duration",
  ];

  const faqs = [
    {
      q: `Do Dubai residents need a visa to visit ${countryName}?`,
      a: `Visa requirements depend on ${countryName}'s bilateral agreement with the UAE and also on your passport nationality. Some countries grant visa-free access to UAE residents regardless of nationality. Contact the ${countryName} Embassy or Consulate in Dubai or our consultants for the latest ${currentYear} policy.`,
    },
    {
      q: `How long does the ${countryName} visa take to process from Dubai?`,
      a: `Standard processing typically takes 7–15 working days from Dubai submission. Peak seasons (summer, Eid holidays) can extend this. We always recommend applying at least 6–8 weeks before travel.`,
    },
    {
      q: `What bank balance is required for a ${countryName} visa from Dubai?`,
      a: `Most embassies expect AED 10,000–30,000 (approx. USD 2,700–8,000) for solo travelers with 3–6 months of stable UAE bank transaction history. The exact amount depends on trip duration and destination. Our consultants can advise based on your profile.`,
    },
    {
      q: `Where do Dubai residents submit the ${countryName} visa application?`,
      a: `Depending on the country, you submit at the ${countryName} Embassy or Consulate in Dubai or Abu Dhabi, at a VFS Global centre in the UAE, or through a BLS/TLScontact centre. Our team will guide you to the correct submission point.`,
    },
    {
      q: `What is the photo specification for ${countryName} visa from Dubai?`,
      a: `Most embassies require 35×45mm photos on a plain white background, ICAO compliant, taken within 3 months. No glasses, no accessories, no heavy retouching. Some countries (e.g. USA) require 51×51mm (2×2 inch) photos.`,
    },
  ];
    ...
    <div className="min-h-screen" style={{ background: "#fff", fontFamily: "'DM Sans',system-ui,sans-serif", color: "#111" }}>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                <span className="tag tag-dark">Dubai &amp; UAE Residents</span>
              ...
              <h1 className="font-display text-4xl md:text-5xl xl:text-6xl leading-tight font-black mb-3" style={{ color: "white" }}>
                {countryName} <span style={{ color: "#f5c800" }}>Tourist Visa</span> for Dubai Residents
              </h1>
              <h2 className="text-base font-semibold mb-4 leading-relaxed" style={{ color: "rgba(255,255,255,0.5)" }}>
                How to apply for {countryName} visa from Dubai — {currentYear} complete requirements guide for UAE residents
              </h2>
              <p className="leading-relaxed text-sm mb-8 max-w-lg" style={{ color: "rgba(255,255,255,.55)" }}>
                Detailed {countryName} visa data for Dubai residents is being prepared. The general requirements below are a reliable starting point. Contact our UAE-based consultants for country-specific guidance.
              </p>
              <div className="flex flex-wrap gap-2 mb-8">
                {["✅ Expert UAE Consultants", "📋 Document Review", "⚡ Fast Processing", "🔒 Confidential"].map(b => (
              ...
              <WhatsAppBtn href={whatsappUrl} label={`Ask About ${countryName} Visa from Dubai`} />
            </div>
            <div className="flex justify-center md:justify-end">
              <div className="relative">
                <div className="w-72 h-48 rounded-2xl overflow-hidden shadow-2xl" style={{ border: "3px solid rgba(245,200,0,.4)" }}>
                  <img src={country.flag} alt={`${countryName} flag — ${countryName} tourist visa from Dubai`} className="w-full h-full object-cover" />
                </div>
      ...
      <div className="max-w-7xl mx-auto px-5 mt-8 mb-6">
        <div className="flex gap-4 items-start p-5 rounded-2xl" style={{ background: "#fff8d6", border: "1.5px solid rgba(245,200,0,.4)" }}>
          ...
          <div>
            <p className="font-black text-black text-sm mb-1">Detailed {countryName} visa data for Dubai residents coming soon</p>
            <p className="text-sm leading-relaxed" style={{ color: "#555" }}>
              Our team is verifying the latest {currentYear} requirements from the {countryName} Embassy and Consulate in the UAE. The checklist below is a reliable general guide. WhatsApp our Dubai-based consultants — they respond within 2 hours.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <section className="card p-8 md:p-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="font-display text-2xl font-black text-black">{countryName} Visa from Dubai — What You Need to Know</h2>
              </div>
              <div className="space-y-4 text-sm leading-relaxed" style={{ color: "#555" }}>
                <p>If you are a <strong className="text-black">Dubai or UAE resident</strong> planning to visit <strong className="text-black">{countryName}</strong>, you will most likely need to apply for a visa in advance. The process involves submitting a document package to the {countryName} Embassy or Consulate in Dubai or Abu Dhabi, or to an authorised Visa Application Centre (VFS Global / BLS International) in the UAE.</p>
                <p>The <strong className="text-black">{countryName} visa for Dubai residents</strong> in {currentYear} generally requires proof of your UAE residency status, financial solvency from a UAE bank, a confirmed travel itinerary, hotel bookings, and a well-structured cover letter. Embassy officers particularly scrutinise UAE residency validity and bank statement patterns.</p>
                <p>Common rejection reasons for Dubai-based applicants: <strong className="text-black">insufficient UAE bank balance or short account history</strong>, expired or about-to-expire UAE residence visa, weak cover letter, non-compliant photographs, and missing employer NOC from a UAE-registered company.</p>
              </div>
            </section>
            ...
            <section className="card p-8 md:p-10">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="font-display text-2xl font-black text-black">Visa Checklist — {countryName} from Dubai</h2>
                  <p className="text-sm mt-0.5" style={{ color: "#777" }}>Standard checklist for Dubai &amp; UAE residents applying for {countryName} visa</p>
                </div>
              </div>
              ...
              <div style={{ borderTop: "1.5px solid #eee", paddingTop: "28px" }}>
                <p style={{ fontSize: "10px", fontWeight: 800, textTransform: "uppercase", letterSpacing: ".15em", color: "#aaa", marginBottom: "20px" }}>Additional Documents by Profession (UAE Context)</p>
                <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    { role: "UAE Salaried",      items: ["NOC / No Objection Letter from UAE employer (on company letterhead)", "Last 3 UAE salary slips", "UAE employment contract", "Company trade licence copy"] },
                    { role: "UAE Business Owner", items: ["UAE trade licence (valid)", "Dubai Chamber of Commerce certificate", "Company UAE bank statement (6 months)", "Memorandum of Association (MOA)"] },
                    { role: "Student (UAE)",      items: ["UAE university / school bonafide certificate", "NOC from institution in UAE", "Sponsor's (parent/guardian) UAE residency + financial proof", "Enrollment letter"] },
                    { role: "Dependent / Spouse", items: ["Sponsor's (husband/wife) UAE residency visa", "Sponsor's UAE bank statement", "Marriage certificate (attested)", "Sponsor NOC letter"] },
                  ].map(({ role, items }) => (
            ...
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <section className="card-yellow p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="font-display text-xl font-black text-black">Approval Tips for Dubai Residents</h2>
                </div>
                <div className="space-y-3">
                  {[
                    "Apply at least 6–8 weeks before your travel date. Dubai-based applications during Eid and school holidays can face longer embassy queues.",
                    "Ensure your UAE residence visa has at least 3–6 months validity remaining at the time of application. A near-expiry residency is a major red flag for embassies.",
                    "Maintain a healthy UAE bank balance for 3–6 months. Avoid large last-minute deposits — embassies scrutinise sudden spikes as suspicious.",
                    "Write a clear cover letter stating your UAE employer, salary, purpose of visit, itinerary, and confirmed return to Dubai.",
                    "Include copies of prior visas (USA, UK, Schengen, etc.) stamped in your passport — prior visa history from Dubai significantly boosts approval chances.",
                  ].map((tip, i) => (
            ...
            <section className="card p-8 md:p-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="font-display text-2xl font-black text-black">Bank Balance Required — {countryName} Visa from Dubai</h2>
                  <p className="text-sm mt-0.5" style={{ color: "#777" }}>General UAE financial guidelines for Dubai resident applicants</p>
                </div>
              </div>
              <div className="grid sm:grid-cols-3 gap-4 mb-6">
                {[
                  { label: "Solo Traveler",  val: "AED 10,000–20,000",  note: "AED 25,000+ recommended",          bg: "#eff6ff", border: "#bfdbfe", col: "#2563eb" },
                  { label: "Couple Travel",  val: "AED 20,000–40,000",  note: "Stable 6-month UAE history",        bg: "#f0fdf4", border: "#bbf7d0", col: "#16a34a" },
                  { label: "Family Trip",    val: "AED 40,000–70,000+", note: "Varies by trip duration & size",    bg: "#faf5ff", border: "#e9d5ff", col: "#9333ea" },
              ...
              <div className="flex gap-3 p-5 rounded-2xl" style={{ background: "#fff8d6", border: "1.5px solid rgba(245,200,0,.4)" }}>
                ...
                <p className="text-sm font-medium leading-relaxed" style={{ color: "#555" }}>
                  <strong className="text-black">Important:</strong> Do not deposit a large lump sum into your UAE account immediately before applying. Embassy officers check transaction history — a sudden spike in a UAE bank account is a red flag. Maintain a stable, consistent balance for at least 3–6 months.
                </p>
              </div>
            </section>
            ...
            <section className="card p-8 md:p-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="font-display text-2xl font-black text-black">FAQ — {countryName} Visa from Dubai {currentYear}</h2>
                  <p className="text-sm mt-0.5" style={{ color: "#777" }}>Common questions from Dubai &amp; UAE residents applying for {countryName} visa</p>
                </div>
              </div>
              <div>
                {faqs.map((item, i) => (
            ...
            <section className="card p-8 md:p-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="font-display text-2xl font-black text-black">{countryName} Visa Guide for Dubai Residents — {currentYear}</h2>
              </div>
              <div className="space-y-5 text-sm leading-relaxed" style={{ color: "#555" }}>
                <p>Getting a <strong className="text-black">{countryName} visa from Dubai</strong> in {currentYear} requires careful preparation, especially regarding your UAE residency documents. Whether you are a tourist, visiting family abroad, or attending a business conference, the document requirements must reflect your UAE-based status — a strong financial file from a UAE bank, clear proof of UAE employment or business, and honest, complete paperwork.</p>
                <h3 className="text-lg font-black text-black">{countryName} Visa Application Process for Dubai &amp; UAE Residents</h3>
                <p>The process begins at the {countryName} Embassy or Consulate in Dubai (or Abu Dhabi), or at a VFS Global / BLS International centre in the UAE. You fill the visa application form, attach your complete UAE residency documents, pay the applicable embassy and service fees, and await the decision. Biometrics are required for most Schengen, UK, USA, and Canadian visa applications.</p>
            ...
            <section className="card-yellow p-8 rounded-2xl">
              ...
              <p className="text-xs mb-6" style={{ color: "#888" }}>Popular tourist visa guides for Dubai &amp; UAE residents — updated 2026</p>
                ...
                {["United States", "United Kingdom", "Canada", "Germany", "Japan", "Australia", "Malaysia", "Thailand"].map(name =>
                  name !== countryName ? (
                    <Link key={name} href={`/visa/dubai-residents/${createSlug(name)}`}
                      title={`${name} tourist visa from Dubai — complete guide`}
          ...
          <aside className="lg:col-span-4 space-y-5">
            ...
            <div className="card p-6">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="font-black text-black text-sm">How to Apply from Dubai — 5 Steps</h3>
              </div>
              <div className="space-y-5 relative">
                <div className="step-line" />
                {[
                  { n: "01", title: "Check Requirements",  desc: `Verify if your nationality + UAE residency is eligible for ${countryName} visa in ${new Date().getFullYear()}` },
                  { n: "02", title: "Collect Documents",   desc: "Gather all required UAE residency & financial papers using the checklist above" },
                  { n: "03", title: "Book Appointment",    desc: "Schedule at VFS Global or embassy in Dubai or Abu Dhabi" },
                  { n: "04", title: "Submit & Pay Fees",   desc: "Submit in person at the UAE centre; all embassy fees are non-refundable" },
                  { n: "05", title: "Track & Collect",     desc: "Monitor status via VFS UAE portal; collect passport when decision is made" },
                ].map((s, i) => (
            ...
            <div className="rounded-2xl p-5" style={{ background: "#eff6ff", border: "1.5px solid #bfdbfe" }}>
              <h3 className="font-black text-black text-sm mb-3 flex items-center gap-2">
                <MapPin size={14} style={{ color: "#2563eb" }} /> VFS / Embassy Centres in UAE
              </h3>
              <div className="space-y-1.5">
                {["Dubai — Business Bay", "Dubai — Deira", "Abu Dhabi — Khalidiyah", "Abu Dhabi — Al Reem Island", "Sharjah", "Al Ain"].map(city => (
              ...
              <p className="text-[10px] mt-3 font-medium" style={{ color: "#4b7db8" }}>Availability varies by destination country. Our team will confirm the nearest UAE centre for you.</p>
            </div>
      ...
      <div className="py-20 px-5 text-center" style={{ background: "#111111", color: "white" }}>
        <div className="max-w-2xl mx-auto">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-black mb-3">Planning to Visit {countryName} from Dubai?</h2>
          <p className="mb-10 leading-relaxed text-sm max-w-lg mx-auto" style={{ color: "rgba(255,255,255,.5)" }}>
            Let our expert UAE consultants guide your {countryName} visa application — the right documents, the right way, with a 98% approval rate for Dubai residents.
          </p>
  ...
  if (!country) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center p-10"
        ...
        <Link href="/visa/dubai-residents" className="btn-yellow px-8 py-4 rounded-2xl text-sm inline-flex">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <div className="flex flex-wrap gap-2 mb-5">
                ...
                <span className="tag" style={{ background: "rgba(245,200,0,.15)", color: "#f5c800", border: "1.5px solid rgba(245,200,0,.25)" }}>🇦🇪 Dubai Residents</span>
              </div>
              <h1 className="font-display text-4xl md:text-5xl xl:text-6xl leading-tight font-black mb-3" style={{ color: "white" }}>
                {countryName} Tourist Visa <span style={{ color: "#f5c800" }}>from Dubai</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                {["✅ 98% Success Rate", "📋 Embassy Verified", "⚡ 24hr Review", "🇦🇪 Dubai Specialist", "🔒 Confidential"].map(b => (
                  <span key={b} className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold"
            ...
            <div className="flex justify-center md:justify-end">
              <div className="relative">
                <div className="w-72 h-48 rounded-2xl overflow-hidden shadow-2xl" style={{ border: "3px solid rgba(245,200,0,.5)" }}>
                  <img src={country.flag} alt={`${countryName} flag — tourist visa from Dubai ${currentYear}`} className="w-full h-full object-cover" />
                </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <section className="card p-8 md:p-10">
              <div className="flex items-center gap-3 mb-6">
                <span className="section-line" />
                <h2 className="font-display text-2xl font-black text-black">{countryName} Visa from Dubai — Everything You Need to Know</h2>
              </div>
              <div className="space-y-4 text-sm leading-relaxed" style={{ color: "#555" }}>
                <p>For <strong className="text-black">Dubai and UAE residents</strong>, obtaining a <strong className="text-black">{countryName} tourist visa</strong> requires careful document preparation, a strong UAE-based financial profile, and a complete application package submitted to the {countryName} Embassy in Dubai or Abu Dhabi, or a designated VFS Global centre in the UAE.</p>
                <p>The <strong className="text-black">{d.visa_category_details?.visa_type}</strong> for {countryName} is processed in <strong className="text-black">{d.processing_time_metrics?.standard_turnaround}</strong>. During UAE peak seasons (Eid, summer, National Day) this can extend to <strong className="text-black">{d.processing_time_metrics?.peak_season_delay}</strong>. We strongly recommend applying at least 6–8 weeks before your travel date.</p>
                <p>Most common rejection reasons for Dubai-based applicants: <strong className="text-black">insufficient or unstable UAE bank balance</strong>, near-expiry UAE residence visa, weak or vague cover letter, non-compliant photographs, and missing UAE employer NOC or trade licence.</p>
              </div>
            </section>
            ...
            <section className="card p-8 md:p-10">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="font-display text-2xl font-black text-black">{countryName} Visa — Mandatory Documents for Dubai Residents</h2>
              ...
              {d.comprehensive_requirements_checklist?.occupation_specific && (
                <div style={{ borderTop: "1.5px solid #eee", paddingTop: "28px" }}>
                  <p style={{ fontSize: "10px", fontWeight: 800, textTransform: "uppercase", letterSpacing: ".15em", color: "#aaa", marginBottom: "20px" }}>04. Occupation-Specific Documents (UAE Context)</p>
                  <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
            ...
            {d.geospatial_submission_data?.length > 0 && (
              <section className="card p-8 md:p-10">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-black text-black">Official Submission Centres in UAE</h2>
                    <p className="text-sm mt-0.5" style={{ color: "#777" }}>Where to submit your {countryName} visa application from Dubai or Abu Dhabi</p>
                  </div>
                </div>
                <div className="grid md:grid-cols-2 gap-5">
            ...
            <section className="card-yellow p-8 md:p-10 rounded-2xl">
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="font-display text-2xl font-black text-black">{countryName} Visa Approval Tips for Dubai Residents</h2>
                  <p className="text-sm mt-0.5" style={{ color: "#888" }}>Insider tips from our UAE consultants — what embassies actually look for</p>
                </div>
              </div>
            ...
            <section className="card p-8 md:p-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="font-display text-2xl font-black text-black">{countryName} Visa Rejection Risks — Dubai Residents</h2>
                  <p className="text-sm mt-0.5" style={{ color: "#777" }}>Why Dubai-based applicants get rejected — and how to avoid it</p>
                </div>
              </div>
            ...
            {d.faq_extended?.length > 0 && (
              <section className="card p-8 md:p-10">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    <h2 className="font-display text-2xl font-black text-black">FAQ — {countryName} Visa from Dubai {currentYear}</h2>
                    <p className="text-sm mt-0.5" style={{ color: "#777" }}>Real questions from Dubai &amp; UAE residents applying for {countryName} visa</p>
                  </div>
                </div>
                <div>
            ...
            <section className="card p-8 md:p-10">
              <div className="flex items-center gap-3 mb-6">
                <span className="section-line" />
                <h2 className="font-display text-2xl font-black text-black">{countryName} Visa for Dubai Residents — {currentYear} Complete Guide</h2>
              </div>
              <div className="space-y-5 text-sm leading-relaxed" style={{ color: "#555" }}>
                <p>Applying for a <strong className="text-black">{countryName} tourist visa from Dubai</strong> involves submitting a complete UAE residency document package to the {countryName} Embassy or VFS Global / BLS centre in the UAE. The {d.visa_category_details?.visa_type} allows a stay of <strong className="text-black">{d.stay_and_validity_rules?.standard_stay}</strong>.</p>
                <h3 className="text-lg font-black text-black">{countryName} Visa Fee for Dubai Residents — {currentYear}</h3>
                <p>The current embassy fee for UAE-based applicants is <strong className="text-black">{d.visa_fee_structure_2026?.embassy_visa_fee}</strong>. VFS Global UAE service charge adds <strong className="text-black">{d.visa_fee_structure_2026?.vfs_service_charge}</strong>. All fees are <strong className="text-black">non-refundable</strong> regardless of outcome.</p>
                <h3 className="text-lg font-black text-black">Bank Balance Required for {countryName} Visa from Dubai</h3>
                <p>Dubai residents should maintain a minimum UAE bank balance of <strong className="text-black">{d.financial_thresholds_2026?.solo_traveler_min}</strong> for solo travel, with <strong className="text-black">{d.financial_thresholds_2026?.solo_traveler_recommended}</strong> recommended. Avoid large last-minute deposits into your UAE account.</p>
                <h3 className="text-lg font-black text-black">{countryName} Visa Photo Size for Dubai Residents</h3>
                <p>Photos must be <strong className="text-black">{d.technical_photo_specifications?.dimensions}</strong> ({d.technical_photo_specifications?.standard}), on a <strong className="text-black">{d.technical_photo_specifications?.background_color}</strong> background, taken within 3 months. Photos can be taken at any photography shop in Dubai.</p>
              </div>
            </section>
            ...
            <section className="card-yellow p-8 rounded-2xl">
              ...
              <div className="grid sm:grid-cols-2 gap-2.5">
                {["United States", "United Kingdom", "Canada", "Germany", "France", "Japan", "Australia", "Malaysia", "Thailand", "Singapore"].map(name =>
                  name !== countryName ? (
                    <Link key={name} href={`/visa/dubai-residents/${createSlug(name)}`}
                      title={`${name} tourist visa from Dubai — complete 2026 guide`}
                      className="flex items-center gap-2 p-3 rounded-xl text-sm font-semibold transition-all group"
                      style={{ background: "rgba(255,255,255,.7)", border: "1.5px solid rgba(245,200,0,.2)", color: "#333" }}>
                      <span className="font-black group-hover:translate-x-0.5 transition-transform" style={{ color: "#d4a800" }}>→</span>
                      {name} Tourist Visa — Dubai Guide
          ...
          <aside className="lg:col-span-4 space-y-5">
            ...
            <div className="rounded-2xl p-6" style={{ background: "#fff8d6", border: "1.5px solid rgba(245,200,0,.4)" }}>
              ...
              <div className="space-y-2 mb-5">
                ...
                <div className="flex justify-between items-center py-3" style={{ borderBottom: "1.5px solid rgba(245,200,0,.2)" }}>
                  <span className="text-sm font-semibold" style={{ color: "#555" }}>VFS UAE Service</span>
            ...
            <div className="card p-6">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="font-black text-black text-sm">Processing Timeline from Dubai</h3>
              </div>
              <div className="space-y-5 relative">
                <div className="step-line" />
                {[
            ...
            <div className="rounded-2xl p-6 text-white" style={{ background: "#111111" }}>
              <div className="flex items-center gap-2 mb-4">
                <CreditCard size={17} />
                <h3 className="font-black text-sm">Minimum UAE Bank Balance</h3>
              </div>
      ...
      <div className="py-20 px-5 text-center" style={{ background: "#111111" }}>
        <div className="max-w-2xl mx-auto">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-black mb-3" style={{ color: "white" }}>
            Ready to Apply for Your <span style={{ color: "#f5c800" }}>{countryName} Visa from Dubai?</span>
          </h2>
          <p className="mb-10 leading-relaxed text-sm max-w-lg mx-auto" style={{ color: "rgba(255,255,255,.45)" }}>
            Let our UAE experts handle your complete application from Dubai — correctly, on time, with a 98% success rate for Dubai &amp; UAE residents.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
