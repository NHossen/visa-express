...
//   description: "Apply for a tourist visa as a Dubai resident. Expert consultancy for USA, UK, Canada, Schengen, Japan, Australia & 200+ countries. 98% approval rate. Embassy-verified documents for UAE residents.",
//   keywords: "tourist visa Dubai residents 2026, visa consultancy Dubai, USA visa Dubai residents, UK visa Dubai residents, Schengen visa Dubai, Canada visa Dubai residents, tourist visa UAE residents, visa on arrival Dubai residents",
    ...
    >
      ...
      <section className="relative w-full flex items-center justify-center overflow-hidden" style={{ minHeight: "560px" }}>
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-5 text-center pt-10 pb-20">
          ...
          <div className="inline-flex items-center gap-2.5 px-5 py-2.5 mb-7 rounded-full bg-white border border-black/10 shadow-sm">
            ...
            <span className="text-xs font-bold text-black/80 tracking-widest uppercase">200+ Countries · Expert Visa Consultancy · Dubai & UAE</span>
          </div>
                    ...
                    {suggestions.map((c, i) => (
                      ...
                      >
                        ...
                        <div className="text-left flex-1">
                          ...
                          <p className="text-[11px] text-black/40">Tourist Visa Guide for Dubai Residents → Apply Now</p>
                        </div>
      ...
      <section className="max-w-6xl mx-auto px-5 py-16" aria-labelledby="categories-heading">
        <div className="flex items-end justify-between mb-10">
          <div>
            ...
            <h2 id="categories-heading" className="text-3xl md:text-4xl font-black text-black">Popular Visa Categories — Dubai &amp; UAE Residents</h2>
          </div>
          <Link href="/visa/dubai-residents" className="text-xs font-bold text-black/40 hover:text-[#f5c800] transition border border-black/10 px-4 py-2 rounded-xl hover:border-[#f5c800]/40">
            All visa types →
          </Link>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-5 pb-6" aria-label="Popular visa destinations for Dubai residents">
        <div className="flex items-center gap-3 flex-wrap">
          <span className="text-xs font-black uppercase tracking-widest text-black/30">🔥 Most Popular for Dubai Residents:</span>
        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <p className="text-black/30 text-sm mt-1">
              {filteredCountries.length} countries · Click any to view full visa requirements for Dubai &amp; UAE residents
            </p>
          </div>
          {(selectedLetter !== "All" || searchTerm) && (
            <button
      ...
      <section className="py-20 max-w-6xl mx-auto px-5" aria-labelledby="testimonials-heading">
        <div className="text-center mb-12">
          ...
          <h2 id="testimonials-heading" className="text-3xl md:text-4xl font-black text-black">Approved by Dubai Residents</h2>
        </div>
      ...
      <section className="border-t border-black/5 py-20" aria-label="About tourist visa from Dubai">
        <div className="max-w-4xl mx-auto px-5">
          <h2 className="text-2xl font-black text-black mb-8">Tourist Visa Consultancy for Dubai Residents — Complete Guide 2026</h2>
          <div className="grid md:grid-cols-2 gap-8 text-sm text-black/50 leading-relaxed">
            <div className="space-y-4">
              <p>
                ...
                Our embassy-certified consultants prepare every document to the exact specification required by each embassy — so your application gets approved from Dubai.
              </p>
              <p>
                From <strong className="text-black/80">bank statement formatting</strong> and NOC letter drafting to photo compliance checks and cover letter writing — we handle everything so your visa application is complete, accurate, and embassy-ready whether you hold a UAE residence visa, work permit, or any other residency status in Dubai.
              </p>
            </div>
            <div className="space-y-4">
              <p>
              ...
              <p>
                Whether you're a first-time traveler or a frequent flyer residing in Dubai, our expert consultants provide personalised guidance — from document preparation to application submission and passport collection at VFS Global and Consulate centres across the UAE.
              </p>
            </div>
          </div>
