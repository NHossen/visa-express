"use client";
// app/scholarships/[slug]/CountryScholarshipsClient.tsx  ← CLIENT COMPONENT
// Receives all data as props from the Server Page — no client-side fetching needed.
...
export default function CountryScholarshipsClient({
  ...
  // Stable random intro picked once on mount
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="bg-white rounded-[2.5rem] p-16 text-center border border-gray-200 shadow-xl shadow-gray-100 mb-16">
            ...
            <p className="text-gray-400 max-w-md mx-auto mb-8 text-sm leading-relaxed">
              ...
              university direct awards, and bilateral agreements. Check back soon —
              we update listings weekly.
            </p>
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-[2rem] p-10 mb-16">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              ...
              Bachelor&apos;s, Master&apos;s, and doctoral level, often including language
              learning support for non-native speakers.
            </p>
          ...
          {/* FAQ section for fallback (SEO boost) */}
          <div className="bg-white border border-gray-100 rounded-[2rem] p-10 mb-16">
            ...
            <div className="space-y-6">
              <FaqItem
                ...
                a={`Yes. ${countryName} offers government-sponsored scholarships, university merit awards, and bilateral scholarship agreements for international students. We are currently verifying the full list of 2026 programs — check back soon.`}
              />
              <FaqItem
        ...
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            ...
            <div className="flex-1">
              {/* h1 is already defined via metadata title but rendered here for visual hierarchy */}
              <h1 className="text-4xl md:text-5xl font-black text-gray-900 capitalize tracking-tight">
                {countryName}{" "}
                <span className="text-blue-600">Scholarships 2026</span>
              </h1>
            ...
            >
              ...
              <div className="px-8 py-5 bg-gray-50/50 flex justify-between items-center border-b border-gray-50 flex-wrap gap-3">
                <div className="flex gap-2 flex-wrap">
                  <span
                    className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-tighter text-white ${
                  ...
                  {s.degree_level?.map((d) => (
                    <span
                      key={d}
                      className="px-4 py-1.5 bg-indigo-50 text-indigo-600 rounded-full text-[10px] font-black uppercase tracking-tighter"
                    >
                      {d}
                    </span>
                  ))}
                ...
                <div className="text-[10px] font-black text-gray-300 uppercase tracking-widest">
                  REF:{" "}
                  {s?._id?.$oid?.slice(-6).toUpperCase() ||
                    s.slug?.slice(-6).toUpperCase() ||
                    "N/A"}
                </div>
              </div>
              ...
              <div className="p-8 md:p-12">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
                  <StatCard
                    icon="🎓"
                    label="Degree Level"
                    value={s.degree_level?.join(" & ") || "Multiple"}
                  />
                  <StatCard
                    icon="💰"
                    label="Award Value"
                    value={s.details?.award_value || "Full Coverage"}
                  />
                  <StatCard
                    icon="📈"
                    label="Min GPA"
                    value={s.details?.min_gpa || "Varies"}
                  />
                  <StatCard
                    icon="🌍"
                    label="IELTS/TOEFL"
                    value={s.details?.ielts || "Required"}
                  />
                </div>
          ...
          <div className="bg-white border border-gray-100 rounded-[2.5rem] p-10 shadow-sm">
            ...
            <div className="prose prose-gray max-w-none text-gray-500 leading-relaxed text-sm space-y-4">
              <p>
                ...
                fully funded government awards — which cover tuition, living
                expenses, and travel — to university merit scholarships that offset
                academic costs for high-achieving applicants.
              </p>
              <p>
                Most scholarships in {countryName} for 2026 require applicants to
                hold a minimum GPA between 3.0 and 3.5, along with proof of English
                language proficiency (IELTS or TOEFL). Some programs additionally
                require letters of recommendation, a statement of purpose, and in
                certain fields, prior work or research experience.
              </p>
              <p>
                Application windows for {countryName} scholarships typically open
                between July and December for the following academic year. We
                recommend beginning your application 3–6 months before the posted
                deadline to allow time for document collection, translations, and
                institution-specific requirements.
              </p>
            </div>

            {/* FAQ section — visible for users, also supports schema */}
        ...
        <aside className="lg:w-80 space-y-6" aria-label="Related scholarships">
          ...
          <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/20 sticky top-10">
            <h3 className="text-lg font-black text-gray-900 mb-6 flex items-center justify-between">
              Browse More{" "}
              <span className="text-xs bg-gray-100 px-2 py-1 rounded">2026</span>
            </h3>
                ...
                {neighborCountries.map((rc) => (
                  ...
                  >
                    <img
                      ...
                      height={20}
                    />
                    <span className="text-sm font-bold text-gray-500 group-hover:text-blue-600 transition leading-tight">
                      {rc.country}
                    </span>
            ...
            <Link
              href="/scholarships"
              className="mt-8 block text-center text-[10px] font-black text-blue-600 uppercase border-t pt-6 hover:tracking-widest transition-all"
            >
          ...
          <div className="bg-gradient-to-br from-red-50 to-orange-50 border border-red-100 p-6 rounded-[2rem]">
            ...
            <p className="text-sm font-bold text-gray-700 mb-3 leading-snug">
              Many {countryName} scholarships close between October–December 2025
              for 2026 intake.
            </p>
            <Link
  ...
  return (
    <div className="border border-gray-100 rounded-2xl overflow-hidden">
      ...
      >
        ...
        <span className={`text-blue-600 text-lg flex-shrink-0 transition-transform ${open ? "rotate-45" : ""}`}>+</span>
      </button>
      {open && (
