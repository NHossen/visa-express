...
//   description: "Apply for a tourist visa from India. Expert consultancy for USA, UK, Canada, Schengen, Japan, Australia & 200+ countries. 98% approval rate. Embassy-verified documents for Indian passport holders.",
//   keywords: "tourist visa India 2026, visa consultancy India, USA visa India, UK visa India, Schengen visa India, Canada visa India, tourist visa Indian passport, visa on arrival India",
...
const SEO_LINKS = [
  ...
  { name: "Schengen Visa from India",      slug: "germany",        desc: "Germany, France, Italy — single Schengen visa guide" },
...
export default function TouristVisaIndia() {
  ...
  return (
    ...
    >
      ...
      <section className="relative w-full flex items-center justify-center overflow-hidden" style={{ minHeight: "560px" }}>
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-5 text-center pt-10 pb-20">
          ...
          <div className="inline-flex items-center gap-2.5 px-5 py-2.5 mb-7 rounded-full bg-white border border-black/10 shadow-sm">
            ...
            <span className="text-xs font-bold text-black/80 tracking-widest uppercase">200+ Countries · Expert Visa Consultancy · India</span>
          </div>
          ...
          {/* H2-level sub-headline — secondary keywords */}
          ...
          <div className="bg-white rounded-3xl p-6 md:p-8 max-w-3xl mx-auto border border-black/5 shadow-2xl mb-4">
            ...
            <div ref={searchRef} className="relative mb-5">
              ...
              <input
                ...
                autoComplete="off"
                aria-label="Search destination country for visa"
              />
              {searchTerm && (
                <button
      ...
      {/* ── VISA CATEGORIES (Internal Links + SEO) ──────────────────────────── */}
      <section className="max-w-6xl mx-auto px-5 py-16" aria-labelledby="categories-heading">
        <div className="flex items-end justify-between mb-10">
          ...
          <Link href="/visa/india" className="text-xs font-bold text-black/40 hover:text-[#f5c800] transition border border-black/10 px-4 py-2 rounded-xl hover:border-[#f5c800]/40">
            All visa types →
          </Link>
        </div>
      ...
      {/* ── POPULAR COUNTRIES (Internal links) ──────────────────────────────── */}
      ...
      <main className="max-w-6xl mx-auto px-5 pb-20" id="all-countries" aria-labelledby="grid-heading">
        ...
        {!isLoaded ? (
            ...
            {currentItems.map((c, i) => (
              ...
              >
                <div className="relative h-28 overflow-hidden bg-gray-200">
                  <img
                    src={c.flag}
                    alt={`${c.country} tourist visa guide for Indian citizens 2026`}
          ...
          <div className="text-center py-24 rounded-3xl border border-black/5 bg-gray-50">
            ...
            <button onClick={resetFilters} className="mt-5 px-6 py-3 bg-[#f5c800] rounded-xl font-black text-sm">
              Show All Countries
            </button>
          </div>
        )}
      ...
      {/* ── SEO ARTICLE FOOTER ────────────────────────────────────────────────── */}
      <section className="border-t border-black/5 py-20" aria-label="About tourist visa from India">
        <div className="max-w-4xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-sm text-black/50 leading-relaxed">
            <div className="space-y-4">
              <p>
                ...
                Our embassy-certified consultants prepare every document to the exact specification required by each embassy — so your application gets approved.
              </p>
              <p>
            ...
            <div className="space-y-4">
              ...
              <p>
                Whether you're a first-time traveler or a frequent flyer from India, our expert consultants provide personalised guidance — from document preparation to application submission and passport collection at VFS Global centres across India.
              </p>
            </div>
          </div>
          ...
          {/* FAQ structured data anchor links (SEO) */}
          <div className="mt-8 pt-8 border-t border-black/5">
            <p className="text-xs text-black/25 font-bold uppercase tracking-widest mb-4">Frequently Asked Questions</p>
            <div className="space-y-4 text-sm">
              {[
                { q: "Which countries can Indian citizens visit without a visa in 2026?", a: "Indian passport holders enjoy visa-free or visa-on-arrival access to 60+ countries including Thailand, Maldives, Indonesia, Nepal, Sri Lanka, Mauritius, Qatar, and more. Use our country search above to check requirements for any destination." },
                { q: "How much bank balance is required for a tourist visa from India?", a: "Most embassies expect ₹1.5–3 lakh for solo travel (3–6 months stable history). Schengen visas typically require €3,000–5,000 equivalent. USA and UK require strong financial documentation. Our consultants advise based on your specific destination." },
                { q: "What is the photo size for a tourist visa from India?", a: "Most embassies require 35×45mm on a plain white background, ICAO compliant, taken within 3 months. Schengen and UK visas require 35×45mm; USA DS-160 accepts 2×2 inch (51×51mm). Check our individual country guides for exact specifications." },
                { q: "How long does visa processing take from India?", a: "Processing times vary: Schengen typically 15 working days, UK 3 weeks, USA 2–6 months (due to interview wait times), Canada 4–8 weeks, Japan 4–7 working days. Apply well in advance and always book refundable flights." },
              ].map((faq, i) => (
