...
//   title: "Tourist Visa for Nigerian Nationals 2026 — 200+ Countries | Visa Expert Hub",
//   description: "Apply for a tourist visa as a Nigerian national. Expert consultancy for USA, UK, Canada, Schengen, Japan, Australia & 200+ countries. 98% approval rate. Embassy-verified documents for Nigerian passport holders.",
//   keywords: "tourist visa Nigerian nationals 2026, visa consultancy Nigeria, USA visa Nigeria, UK visa Nigeria, Schengen visa Nigeria, Canada visa Nigerian passport, tourist visa Nigeria, visa on arrival Nigerian passport, Nigerian passport visa free countries 2026",
...
const WHY_US = [
  { icon: "🛡️", title: "98% Approval Rate",         desc: "Our consultants have helped thousands of Nigerian passport holders get approved worldwide. We understand exactly what embassies look for from Nigerian applicants." },
  { icon: "📋", title: "Embassy-Accurate Documents", desc: "Every checklist is verified against official embassy circulars & VFS Global announcements, updated monthly for 2026 protocols for Nigerian nationals." },
  { icon: "⚡", title: "24-Hour Document Review",    desc: "Rapid review and expert feedback eliminates rejection risks before submission — critical for Nigerian passport applications." },
  { icon: "🌍", title: "200+ Countries Covered",     desc: "Schengen to Southeast Asia — tourist, business, student & medical visas expertly handled for Nigerian passport holders." },
];

const TESTIMONIALS = [
  { name: "Chidinma Okonkwo", country: "UK Visa Approved ✅",     text: "Got my UK Standard Visitor visa approved in 15 days from Lagos. The team reviewed every document and my cover letter — no issues at all at the British High Commission in Abuja.", stars: 5 },
  { name: "Emeka Adeyemi",    country: "Schengen Approved ✅",    text: "Applied for Germany Schengen as a Nigerian national through them. Perfect checklist, strong financial file guidance, zero rejection. Highly recommend for Nigerians applying abroad.", stars: 5 },
  { name: "Ngozi Eze",        country: "Canada Visa Approved ✅", text: "Canada Visitor Visa (TRV) — they helped me structure everything exactly the way IRCC expects from a Nigerian applicant. Approved in 4 weeks from Abuja!", stars: 5 },
];

const SEO_LINKS = [
  { name: "USA B1/B2 Tourist Visa",          slug: "united-states", desc: "DS-160, bank statement, interview tips for Nigerians — US Embassy Abuja & Lagos" },
  { name: "UK Standard Visitor Visa",        slug: "united-kingdom", desc: "UKVI checklist, photo specs, financial proof for Nigerian passport holders" },
  { name: "Canada Visitor Visa (TRV)",       slug: "canada",         desc: "IRCC requirements, biometrics, checklist for Nigerian nationals" },
  { name: "Schengen Visa from Nigeria",      slug: "germany",        desc: "Germany, France, Italy — Schengen visa guide for Nigerian passport holders" },
  { name: "Japan Tourist Visa",              slug: "japan",          desc: "Embassy checklist, bank balance for Nigerian passport holders" },
  { name: "Australia Tourist Visa",          slug: "australia",      desc: "Subclass 600, documents, processing time for Nigerians" },
  { name: "Malaysia e-Visa",                 slug: "malaysia",       desc: "eNTRI, eVISA — online visa options for Nigerian nationals" },
  { name: "Thailand Tourist Visa",           slug: "thailand",       desc: "TR visa from Royal Thai Embassy for Nigerian passport holders" },
  { name: "Singapore Tourist Visa",          slug: "singapore",      desc: "ICA requirements, tourist pass guide for Nigerians" },
];
...
const VISA_CATEGORIES = [
  ...
  { label: "Middle East",        icon: "🕌", desc: "UAE, Saudi Arabia, Qatar, Oman — Nigerian passport guide",        href: "/visa/middle-east-visa" },
...
// COMPONENT
// ─────────────────────────────────────────────────────────────────────────────
export default function TouristVisaNigerianNationals() {
  ...
  return (
    ...
    >
      ...
      <section className="relative w-full flex items-center justify-center overflow-hidden" style={{ minHeight: "560px" }}>
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-5 text-center pt-10 pb-20">
          ...
          <div className="inline-flex items-center gap-2.5 px-5 py-2.5 mb-7 rounded-full bg-white border border-black/10 shadow-sm">
            ...
            <span className="text-xs font-bold text-black/80 tracking-widest uppercase">200+ Countries · Expert Visa Consultancy · Nigerian Passport</span>
          </div>

          <h1 className="text-3xl md:text-5xl lg:text-[52px] font-black leading-[0.95] tracking-tight mb-5 text-black">
            Tourist Visa for <span className="text-[#f5c800]">Nigerian Nationals</span> —<br />
          ...
          <p className="text-black/60 text-base md:text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            <strong className="text-black">29-country Schengen Area</strong> — handled by expert visa consultants for Nigerian passport holders worldwide.
          </p>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-8 max-w-3xl mx-auto border border-black/5 shadow-2xl mb-4">
            ...
            <div ref={searchRef} className="relative mb-5">
              ...
              <input
                ...
                autoComplete="off"
                aria-label="Search destination country for visa for Nigerian passport"
              />
              {searchTerm && (
                <button
                ...
                <div className="absolute top-full left-0 right-0 mt-2 rounded-2xl overflow-hidden z-50 shadow-2xl bg-white border border-[#f5c800]/30">
                  <div className="p-2">
                    ...
                    {suggestions.map((c, i) => (
                      <Link
                        key={i}
                        href={`/visa/nigeria/${createSlug(c.country)}`}
                      ...
                      >
                        ...
                        <div className="text-left flex-1">
                          ...
                          <p className="text-[11px] text-black/40">Tourist Visa Guide for Nigerian Nationals → Apply Now</p>
                        </div>
            ...
            <div className="flex items-center justify-between text-xs text-black/40 font-bold px-1">
              <span>{filteredCountries.length} destinations available for Nigerian passport holders</span>
      ...
      <section className="max-w-6xl mx-auto px-5 py-16" aria-labelledby="categories-heading">
        <div className="flex items-end justify-between mb-10">
          <div>
            ...
            <h2 id="categories-heading" className="text-3xl md:text-4xl font-black text-black">Popular Visa Categories — Nigerian Passport</h2>
          </div>
          <Link href="/visa/nigeria" className="text-xs font-bold text-black/40 hover:text-[#f5c800] transition border border-black/10 px-4 py-2 rounded-xl hover:border-[#f5c800]/40">
            All visa types →
          </Link>
        </div>
      ...
      {/* ── POPULAR COUNTRIES ───────────────────────────────────────────────── */}
      <section className="max-w-6xl mx-auto px-5 pb-6" aria-label="Popular visa destinations for Nigerian nationals">
        <div className="flex items-center gap-3 flex-wrap">
          <span className="text-xs font-black uppercase tracking-widest text-black/30">🔥 Most Applied by Nigerians:</span>
          ...
          <div>
            <h2 id="grid-heading" className="text-2xl md:text-3xl font-black text-black">
              {selectedLetter === "All" && !searchTerm
                ? "All Visa Destinations — Nigerian Nationals 2026"
                : searchTerm
                ? `Results for "${searchTerm}"`
                : `Countries Starting with "${selectedLetter}"`}
            </h2>
            <p className="text-black/30 text-sm mt-1">
              {filteredCountries.length} countries · Click any to view full visa requirements for Nigerian passport holders
            </p>
          </div>
          {(selectedLetter !== "All" || searchTerm) && (
            <button
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {currentItems.map((c, i) => (
              <Link
                ...
                title={`${c.country} Tourist Visa — Nigerian Passport Guide 2026`}
              >
                <div className="relative h-28 overflow-hidden bg-gray-200">
                  <img
                    src={c.flag}
                    alt={`${c.country} tourist visa guide for Nigerian nationals 2026`}
      ...
      <section className="border-t border-black/5 py-24 bg-gray-50" aria-labelledby="why-heading">
        <div className="max-w-6xl mx-auto px-5">
          <div className="text-center mb-16">
            <p className="text-[#f5c800] text-xs font-black uppercase tracking-widest mb-3">Why Thousands of Nigerians Trust Us</p>
            <h2 id="why-heading" className="text-4xl md:text-5xl font-black text-black mb-4">
              Nigeria's Most Trusted<br />Tourist Visa Consultancy
            </h2>
            <p className="text-black/40 max-w-xl mx-auto text-sm leading-relaxed">
              We don't just tell you what documents you need — we verify them, format them, and ensure your Nigerian passport application is embassy-ready.
            </p>
          </div>
      ...
      <section className="py-20 max-w-6xl mx-auto px-5" aria-labelledby="testimonials-heading">
        <div className="text-center mb-12">
          ...
          <h2 id="testimonials-heading" className="text-3xl md:text-4xl font-black text-black">Approved — Nigerian Passport Holders</h2>
        </div>
      ...
      <section className="border-t border-black/5 py-20 bg-gray-50" aria-labelledby="guides-heading">
        <div className="max-w-6xl mx-auto px-5">
          <h2 id="guides-heading" className="text-2xl md:text-3xl font-black text-black mb-3">
            Popular Tourist Visa Guides — Nigerian Nationals 2026
          </h2>
          <p className="text-black/40 text-sm mb-10">
            Complete visa guides with required documents, embassy fees, bank balance requirements &amp; expert tips for Nigerian passport holders
          </p>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {SEO_LINKS.map((link, i) => (
              <Link
                key={i}
                href={`/visa/nigeria/${link.slug}`}
                ...
                title={`${link.name} — Complete guide for Nigerian passport holders`}
              >
      ...
      {/* ── SEO ARTICLE FOOTER ────────────────────────────────────────────────── */}
      <section className="border-t border-black/5 py-20" aria-label="About tourist visa for Nigerian nationals">
        <div className="max-w-4xl mx-auto px-5">
          <h2 className="text-2xl font-black text-black mb-8">Tourist Visa for Nigerian Nationals — Complete Guide 2026</h2>
          <div className="grid md:grid-cols-2 gap-8 text-sm text-black/50 leading-relaxed">
            <div className="space-y-4">
              <p>
                We are a leading visa consultancy for Nigerian nationals, helping thousands of Nigerian passport holders secure visas for{" "}
                <strong className="text-black/80">USA, UK, Canada, Schengen, Japan, Australia</strong> and 200+ destinations worldwide.
                Our embassy-certified consultants prepare every document to the exact specification required by each embassy — built for Nigerian applicants.
              </p>
              <p>
                From <strong className="text-black/80">bank statement formatting</strong> and sponsor letter drafting to photo compliance checks and cover letter writing — we handle everything so your Nigerian passport application is complete, accurate, and embassy-ready from Lagos, Abuja, Port Harcourt, or wherever you are.
              </p>
            </div>
            <div className="space-y-4">
              <p>
                Our 2026 visa guides are updated monthly based on official embassy circulars from the US Embassy Abuja, British High Commission Nigeria, and VFS Global Nigeria.
                We track policy changes specifically affecting Nigerian nationals — so you don't have to.
              </p>
              <p>
                Whether you are applying from Lagos or Abuja, our expert consultants provide personalised guidance — from document preparation to application submission and passport collection at VFS Global centres and embassy collection points across Nigeria.
              </p>
            </div>
          </div>
          ...
          <div className="mt-10 pt-8 border-t border-black/5">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                { label: "USA Visa",      href: "/visa/nigeria/united-states" },
                { label: "UK Visa",       href: "/visa/nigeria/united-kingdom" },
                { label: "Canada Visa",   href: "/visa/nigeria/canada" },
              ].map(link => (
                <Link
                  key={link.label}
                  href={link.href}
          ...
          <div className="mt-8 pt-8 border-t border-black/5">
            ...
            <div className="space-y-4 text-sm">
              {[
                {
                  q: "Which countries can Nigerian nationals visit without a visa in 2026?",
                  a: "Nigerian passport holders enjoy visa-free or visa-on-arrival access to around 45–50 countries, including Benin, Cameroon, Chad, Ghana, Kenya, Seychelles, Cape Verde, Maldives, Malaysia (30 days), Singapore (30 days), and Barbados, among others. Use our country search above to check requirements for any destination.",
                },
                {
                  q: "How much bank balance is required for a tourist visa for Nigerian nationals?",
                  a: "Most embassies expect a minimum NGN equivalent of USD 3,000–8,000 (approximately NGN 4.5 million–12 million at current rates) for solo travel with 3–6 months of stable bank transaction history. Schengen visas typically require €3,000–5,000 equivalent. USA and UK require strong financial documentation showing consistent income and assets.",
                },
                {
                  q: "What documents do Nigerian nationals need for a tourist visa application?",
                  a: "Core documents include: valid Nigerian international passport (minimum 6 months validity), Nigerian bank statements (6 months), proof of employment or business registration in Nigeria, confirmed flight and hotel bookings, travel insurance, and a clear cover letter explaining purpose of travel and ties to Nigeria. Specific requirements vary by destination country.",
                },
                {
                  q: "Where do Nigerian nationals submit visa applications?",
                  a: "Depending on the destination country, you submit at the respective embassy or consulate in Nigeria (Lagos or Abuja), at a VFS Global Nigeria centre, or through a BLS/TLScontact centre. US visa applicants attend interviews at the US Embassy in Abuja or Consulate in Lagos. Our team confirms the correct submission point for your target country.",
                },
                {
                  q: "How long does visa processing take for Nigerian passport holders?",
                  a: "Processing times vary significantly: Schengen typically 15–20 working days (often longer from Nigeria), UK 3–4 weeks, USA 3–12 months (interview wait times at Abuja/Lagos are very long — check the current wait time on the US Embassy website), Canada 6–12 weeks, Japan 5–7 working days. Always apply as early as possible.",
                },
              ].map((faq, i) => (
