...
const Footer = () => {
  return (
    <footer className="w-full overflow-hidden text-[#4b4b4b] font-sans pt-16 bg-white">
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">

        {/* TOP SECTION - Brand + Trust */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-14 border-b border-gray-100 min-w-0">

          {/* Brand Column */}
          <div className="lg:col-span-4 space-y-5 min-w-0">

            {/* Logo */}
            <Link href="/" className="inline-flex items-center gap-3 no-underline group max-w-full">
              <div className="relative w-56 sm:w-64 h-20 flex-shrink-0 -ml-6 sm:-ml-10 max-w-full">
                <Image
                  src="/visa_express_hub_log.png"
                  alt="Visa Express Hub Logo"
                  fill
                  priority
                  className="scale-[1.65] origin-left"
                  style={{
                    objectFit: 'contain',
                    objectPosition: 'left',
                  }}
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-10 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="flex flex-wrap gap-5 items-center max-w-full">
                <img
                  src="https://www.alliancealliance.com/wp-content/uploads/2018/03/IATA-icon.png"
                  alt="IATA Approved"
                  width={80}
                  height={80}
                  className="object-contain grayscale hover:grayscale-0 transition-all duration-200 max-w-full"
                />
                <img
            ...
            <div className="min-w-0">
              ...
              <div className="flex flex-wrap gap-4 items-center max-w-full">
                {[
                  ...
                  <div
                    key={pm.alt}
                    className="h-10 px-3 bg-gray-50 border border-gray-200 rounded-lg flex items-center justify-center hover:border-[#FED700] transition-all duration-200 max-w-full"
                  >
                    <img
                      src={pm.src}
                      alt={pm.alt}
        ...
        {/* MIDDLE - Nav Links */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 py-14 min-w-0">
            ...
            <nav className="flex flex-col space-y-2.5 mt-3">
              {[
                ...
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-[#696969] hover:text-[#111] hover:translate-x-1 transition-all duration-150 text-[14px] flex items-center gap-1.5 group no-underline break-words"
                >
            ...
            <nav className="flex flex-col space-y-2.5 mt-3">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`${s.color} hover:underline text-[14px] font-medium transition-all no-underline hover:translate-x-1 duration-150 flex items-center gap-2 break-words`}
                >
                  {s.label}
                </a>
              ))}
          ...
          <div className="min-w-0">
            ...
            <div className="flex flex-col gap-3 mt-3 min-w-0">
              <div className="flex w-full max-w-full border-2 border-gray-200 rounded-xl overflow-hidden focus-within:border-[#FED700] transition-all duration-200">
                <input
                  type="email"
                  placeholder="info@visaexpresshub.com"
                  className="flex-1 w-full px-3 py-3 text-sm bg-transparent border-none outline-none text-gray-700 placeholder:text-gray-400 min-w-0"
                />
              ...
              <div className="flex gap-2 w-full max-w-full">
                <Link
                  ...
                  className="flex-1 min-w-0 text-center py-2.5 text-sm font-bold border-2 border-black text-black rounded-xl hover:bg-[#FED700] hover:border-[#FED700] transition-all duration-200 no-underline"
                >
                  Log in
                </Link>
                <Link
                  href="/auth?mode=signup"
                  className="flex-1 min-w-0 text-center py-2.5 text-sm font-bold bg-[#FED700] text-black rounded-xl border-2 border-[#FED700] hover:bg-[#e0c000] hover:border-[#e0c000] transition-all duration-200 no-underline shadow-[0_4px_14px_rgba(254,215,0,0.35)]"
                >
                  Sign Up
                </Link>
              </div>
        ...
        {/* BOTTOM - Copyright */}
        <div className="border-t border-gray-100 py-8 flex flex-col lg:flex-row justify-between items-center gap-4 min-w-0">
          <p className="text-sm text-[#696969] text-center lg:text-left max-w-full break-words">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-2 text-xs text-gray-400 justify-center max-w-full">
            {[
              { label: 'Privacy Policy', href: '/privacy-policy' },
          ...
          <p className="text-[#FED700] text-base font-bold tracking-tight italic text-center whitespace-normal">
            Visa Help, Anytime, Anywhere
          </p>
        </div>
